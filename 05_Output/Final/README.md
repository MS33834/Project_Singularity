...
> 本目录存放项目最终交付物与母版文件。  
> 以 Project Singularity /《奇点回响》为示例，实际项目请按需求调整规格。
...
├── project_singularity_4k_master.mp4    # 4K 最终成片（示例文件名）
├── project_singularity_1080p.mp4        # 1080P 网络版（示例文件名）
├── project_singularity_vertical.mp4     # 竖版短视频（示例文件名）
└── project_singularity_stereo.wav       # 独立立体声母版（示例文件名）
```
