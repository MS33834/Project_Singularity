...
def main():
    ...
    report = []
    report.append("# Project Singularity — 资产盘点与进度看板\n")
    ...
    key_assets = [
        ("完整剧本", PROJECT_ROOT / "02_Scripts" / "奇点回响_剧本与世界观.md"),
        ("详细分镜表", PROJECT_ROOT / "02_Scripts" / "详细分镜表.md"),
        ("关键帧提示词", PROJECT_ROOT / "02_Scripts" / "关键帧提示词汇总表.md"),
        ("角色圣经模板", PROJECT_ROOT / "02_Scripts" / "角色圣经_模板.md"),
        ...
        ("节点连接说明", PROJECT_ROOT / "03_Workflows" / "ComfyUI节点连接说明.md"),
        ("SOP 操作手册", PROJECT_ROOT / "04_SOP" / "SOP_Project_Singularity.md"),
        ("后期制作规范", PROJECT_ROOT / "04_SOP" / "后期制作规范.md"),
        ("音频制作规范", PROJECT_ROOT / "04_SOP" / "音频制作规范.md"),
        ...
        ("项目计划书", PROJECT_ROOT / "项目计划书_完整版.md"),
        ("检查清单", PROJECT_ROOT / "项目进度检查清单.md"),
        ("教师评审表", PROJECT_ROOT / "教师评审表_模板.md"),
        ("周报模板", PROJECT_ROOT / "周报模板.md"),
        ("总结报告模板", PROJECT_ROOT / "项目总结报告_模板.md"),
    ]
