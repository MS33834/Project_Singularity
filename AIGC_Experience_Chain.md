...
Project Singularity 就是把这些问题串成一条**可执行、可复现、可协作**的管线。我们用一个科幻短片《奇点回响》当示例，把从剧本到 4K 母版的每一步都写成文档、脚本和工作流，方便自己下次复用，也方便别人拿去改。
...
└── 29 张场景关键帧
      ↓
动态层
├── Wan2.2 I2V 14B → 19 个标准镜头
└── 可灵 2.5 Turbo 首尾帧 → 5 个复杂/转场镜头
      ↓
合成层
├── 达芬奇粗剪 + 锁定剪辑
├── ElevenLabs 配音
