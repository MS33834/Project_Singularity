...
> 项目：Project Singularity /《奇点回响》（示例）  
> 作者：项目技术团队  
...
（详见 [`06_Research/失败案例记录表.md`](../06_Research/失败案例记录表.md)）

---

## 五、资源下载

- GitHub 仓库：https://github.com/MS33834/Project_Singularity
- GitCode 仓库：https://gitcode.com/badhope/Project_Singularity
- ComfyUI 工作流打包：`05_Output/Final/workflows/Project_Singularity_Workflows_v1.0.zip`
- SOP 手册：`04_SOP/SOP_Project_Singularity.md`
