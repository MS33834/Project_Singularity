...
This directory contains the full plan and production records for the example project used throughout Project Singularity. It is meant to show how the generic workflow templates in the repository map to a real (albeit fictional) production.
...
- [`../../02_Scripts/详细分镜表.md`](../../02_Scripts/详细分镜表.md)
...
- **Project code**: Project Singularity
- **Chinese title**: 奇点回响
...
If you want to use Project Singularity for your own film, replace the content of these files with your own story and keep the structure.
...
3. [`../../02_Scripts/详细分镜表.md`](../../02_Scripts/详细分镜表.md) — the 24-shot breakdown
...
> Maintained by the Project Singularity team. Last updated 2026-06-25.
